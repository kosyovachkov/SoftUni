namespace Blog.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<Blog.Models.BlogDbContext>
    {
        ...
        protected override void Seed(BlogDbContext context)
        {
            if (!context.Users.Any())
            {
                ...
                CreateArticle(context,
                    ...
                    content: @"<p>Version 2.8 of the open-source distributed version-control system Git has been released. The new edition provides a variety of new features, bugfixes and other improvements.</p>
                ...
                CreateArticle(context,
                    ...
                    content: @"<p>Rogue Wave is updating its open-source framework for developing Web applications and services. According to the company, this is the first major release in four years. Zend Framework 3 features support for PHP 7, middleware runtime and performance enhancements.</p>
        ...
        private void CreateUser(BlogDbContext context,
        ...
        private void AddUserToRole(BlogDbContext context, string userName, string roleName)
        {
        ...
        private void CreateArticle(BlogDbContext context,
            string title, string content, DateTime date, string authorUsername)
        {
